window.onload = function () {
  ...
  const minerals = [
      ...
      { name: "Obsidian", img: "../Images/ores/obsidian.png", rarity: "1/1500" },
  ...
  settingsToggle.textContent = isVisible ? "Settings" : "Hide Settings";
});


  const oreData = [
    { name: "Stone", image: "../Images/ores/stone.png", rarity: "1/3" },
    { name: "Coal", image: "../Images/ores/coal.png", rarity: "1/4.5" },
    { name: "Iron", image: "../Images/ores/iron.png", rarity: "1/10" },
    { name: "Gold", image: "../Images/ores/gold.png", rarity: "1/20" },
    { name: "Diamond", image: "../Images/ores/diamond.png", rarity: "1/100" },
    { name: "Ruby", image: "../Images/ores/ruby.png", rarity: "1/250" },
    { name: "Sapphire", image: "../Images/ores/sapphire.png", rarity: "1/250" },
    { name: "Viridian", image: "../Images/ores/viridian.png", rarity: "1/500" },
    { name: "Amethyst", image: "../Images/ores/amethyst.png", rarity: "1/750" },
    { name: "Obsidian", image: "../Images/ores/obsidian.png", rarity: "1/1500" },
    { name: "Firesteel", image: "../Images/ores/firesteel.png", rarity: "1/2500" },
    { name: "Dragonsteel", image: "../Images/ores/dragonsteel.png", rarity: "1/10000" }
  ];
  
  const oreList = document.getElementById("oreList");
  const oreIndexMenu = document.getElementById("oreIndexMenu");
  const oreIndexToggle = document.getElementById("oreIndexToggle");
  
  //makes the ore rarity sort from rarest to least rare in the inventory
  oreData.forEach(ore => {
    const div = document.createElement("div");
    div.className = "ore-item";
    div.innerHTML = `
      <img src="${ore.image}" alt="${ore.name}">
      <div class="rarity-tooltip">${ore.name} - ${ore.rarity}</div>
    `;
    oreList.appendChild(div);
  });
  
  //button for ore index
  oreIndexToggle.addEventListener("click", () => {
    oreIndexMenu.style.display = oreIndexMenu.style.display === "none" ? "block" : "none";
    oreIndexToggle.textContent = oreIndexMenu.style.display === "block" ? "Hide Ore Index" : "Show Ore Index";
  });

  //clover spawn script + luck boost 
